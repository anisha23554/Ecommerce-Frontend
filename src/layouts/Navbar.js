...
// const Navbar = () => {
//     return ( 
//         <ul style={{display:"flex",justifyContent:"space-evenly",listStyleType:"none",fontSize:"1.3rem"}}>
//             {/* using <link> instead of <a> bcoz using <a> page reloads everytime route is changed */}
//             {/* <link> enables to change the route without reloading */}
        ...
        <Box>
            <Flex
                ...
                <Stack
                    ...
                    <Button onClick={handleLogout} as={lee} to="/login" bg={'red.400'}
                             color={'white'}>
                        Logout
                    </Button>
                </Stack>
